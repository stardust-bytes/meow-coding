...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle(Channels.ProviderConnect, (_e, providerId: string, apiKey: string, baseUrl?: string, models?: string[], providerType?: string) =>
    mainApp.meowAgent.connectProvider(providerId, apiKey, baseUrl, models, providerType))
