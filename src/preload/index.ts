...
const api: AgentApi = {
  ...
  connectProvider: (providerId: string, apiKey: string, baseUrl?: string, models?: string[], providerType?: string) =>
    ipcRenderer.invoke(Channels.ProviderConnect, providerId, apiKey, baseUrl, models, providerType),
